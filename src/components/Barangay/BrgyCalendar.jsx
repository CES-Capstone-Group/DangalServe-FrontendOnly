...
function CoorCalendar() {
    ...
    const handleEventClick = (clickInfo) => {
        ...
        setSelectedEvent({
            ...
            venue: event.extendedProps.venue || "No venue provided", // Correct access
            objectives: event.extendedProps.objectives || "No objectives provided" // Correct access
        });
    ...
    const renderEventModal = () => {
        ...
        const { proposal, activity, date, time, venue, activityObjectives } = selectedEvent;
        return (
                        ...
                        <Form.Group as={Row} className="mb-3" controlId="activityObjectives">
                            ...
                            <Col>
                                <Form.Control
                                    as="textarea"
                                    rows={3}
                                    value={selectedEvent?.objectives || ""}
                                    readOnly
                                />
                            </Col>
                        </Form.Group>
